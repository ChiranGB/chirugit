...
FROM (user_profile as u NATURAL JOIN expense as e) where date >= DATE_SUB(CURDATE(),INTERVAL 7 DAY) and user_id = '$curuser'";
...
<html>
    ...
    <div class='subheader'><h3 style = "text-align:center;">Expense Record of last 7 days</h3>
