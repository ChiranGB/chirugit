...
$qry2="SELECT u.name,e.user_id, e.category,e.amount,e.location, e.date,e.expenseNo
FROM (user_profile as u NATURAL JOIN expense as e) where user_id = '$curuser'";
...
<html>
    ...
    <div class='subheader'><h3 style = "text-align:center;">Overall Expense Records</h3>
        <table>
        <tr>
        <th>Expense no.</th>
            <th>Date</th>
        ...
        while($rows=mysqli_fetch_assoc($result1)){
            ...
            <td><?php echo $rows['expenseNo']; ?> </td>
                ...
                <td><a href="delete.php?id=<?php echo $rows['expenseNo']?>" onclick="return confirm('Are you sure you want to delete this item?');">Delete</a></td>
