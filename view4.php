...
FROM (user_profile as u NATURAL JOIN expense as e) where e.category='$search' and user_id = '$curuser'";
...
<html>
    ...
    <div class='subheader'><h2>Expense Record of category: <?php echo $search ?> </h2>
    </div>
    <table>
        <tr>
        <th>Expense no.</th>
