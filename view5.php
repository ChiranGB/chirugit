...
FROM (user_profile as u NATURAL JOIN expense as e) where amount>10000 and user_id = '$curuser'";
...
<html>
    ...
    <div class='subheader'><h3 style = "text-align:center;">Expense Record of amount > 10k</h3>
